...
const bioEngineeringEngineeringDistributions = [
  (course: Course): boolean => courseMatchesCodeOptions(course, ['ENGRD 2020']),
  (course: Course): boolean => courseMatchesCodeOptions(course, ['ENGRD 2600', 'ENGRD 2510'])
];
...
const bioEngineeringRequiredMajorCourses = [
  (course: Course): boolean => courseMatchesCode(course, 'BIOG/BIOSM 1500'),
  (course: Course): boolean => courseMatchesCode(course, 'BEE 3500'),
  (course: Course): boolean => courseMatchesCode(course, 'BEE 3310'),
  (course: Course): boolean => courseMatchesCode(course, 'BEE 3400'),
  (course: Course): boolean => courseMatchesCode(course, 'BEE 3600'),
  (course: Course): boolean => courseMatchesCode(course, 'BEE 4500')
];

const bioEngineeringBioChemistry = [
  (course: Course): boolean => courseMatchesCodeOptions(course, ['BIOMG 3300', 'BIOMG 3330', 'BIOMG 3350', 'BIOMG 3310']),
  (course: Course): boolean => courseMatchesCode(course, 'BIOMG 3320')
];
...
const bioEngineeringFocusAreaElective = (course: Course): boolean => courseMatchesCodeOptions(
  course,
  [
