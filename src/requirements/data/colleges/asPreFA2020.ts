...
const casPreFA2020Requirements: readonly CollegeOrMajorRequirement[] = [
  ...
  },
  {
    ...
    description:
      'Pass an intermediate Cornell language course at the 2000-level or above (Option 1) or complete at least 11 credits in a single foreign language at Cornell (Option 2). ' + 
    ...
    fulfillmentOptions: {
      'Option 1': {
        description: 'Complete one intermediate course of 3 or more credits at Cornell at the 2000 level or above.',
      ...
      'Option 2': {
        description: 'Complete at least 11 credits of study (2 or 3 semesters) in a single foreign language taken in the appropriate sequence at Cornell.',
  ...
  },
  {
    ...
    description: 'Students must take 2 courses in Physical & Biological Sciences (PBS-AS).',
    source: 'https://as.cornell.edu/degree-requirements',
    checker: (course: Course): boolean =>
      ['(PBS-AS)', '(PBSS-AS)'].some(
  ...
  },
  {
    ...
    description:
      'Students must take 1 more course in Mathematics & Quantitative Reasoning (MQR-AS) or Physical & Biological Sciences (PBS-AS).',
    source: 'https://as.cornell.edu/degree-requirements',
    checker: (course: Course): boolean =>
  ...
  },
  {
    ...
    source: 'https://as.cornell.edu/degree-requirements',
    checker: (course: Course): boolean =>
    ['CA-AS', 'HA-AS', 'LA-AS', 'KCM-AS', 'SBA-AS'].some(
      distribution => course.catalogDistr?.includes(distribution) ?? false
    ),
    operator: 'or',
    fulfilledBy: 'courses',
  ...
  {
    name: 'Liberal Arts Categories Checker',
    description:
      'Liberal Arts courses need to come from at least 4 of the following categories: CA-AS, HA-AS, KCM-AS, LA-AS, and SBA-AS',
    source: 'https://as.cornell.edu/degree-requirements',
    checker: [
