...
const foodSciRequirements: readonly CollegeOrMajorRequirement[] = [
  {
    ...
    checker: includesWithSingleRequirement(
      'BIOG 1140', 'BIOG 1440', 'BIOG 1500', 'BIOEE 1610', 'BIOEE 1780', 'BIOAP 1100', 'PLSCI 1115'
    ),
    fulfilledBy: 'courses',
    perSlotMinCount: [2],
    slotNames: ['Courses'],
  ...
  },
  {
    name: 'Statistics',
    description:
      'AEM 2100 or STSCI 2100 or STSCI 2150 or STSCI 2200 or MATH 1710 or PSYCH 3500',
    source:
      'https://cals.cornell.edu/education/degrees-programs/food-science-major-minor',
    checker: includesWithSingleRequirement(
      'AEM 2100', 'STSCI 2100', 'STSCI 2150', 'STSCI 2200', 'MATH 1710', 'PSYCH 3500'
    ),
    fulfilledBy: 'courses',
    perSlotMinCount: [1],
    slotNames: ['Course'],
  },
  {
    ...
    description:
      'BIOMI 2900 (lecture) and BIOMI 2911 (lab)',
    source:
      'https://cals.cornell.edu/education/degrees-programs/food-science-major-minor',
  ...
  },
  {
    name: 'Biochemistry',
    description:
      'BIOMG 3310 or BIOMG 3350 or NS 3200',
    source:
      'https://cals.cornell.edu/education/degrees-programs/food-science-major-minor',
  ...
  {
    name: 'Core Courses',
    description: 'These are the core courses required for every concentration.'
    ...
    slotNames: ['FDSC 1101', 'FDSC 1102', 'NS 1150', 'FDSC 2000', 'FDSC 2100', 'FDSC 2110', 'FDSC 3940', 'FDSC 3960', 'FDSC 4000', 'FDSC 4170', 'FDSC 4210'],
  },
  {
    name: 'Concentration',
    description:
      'Students are required to complete one concentration from Science, Safety and Business.',
    checkerWarning: 'For the optional electives in each concentration, we do not check whether the courses selected fulfil the minimum credits needed for that category.',
    source:
      'https://cals.cornell.edu/education/degrees-programs/food-science-major-minor',
    fulfilledBy: 'toggleable',
    ...
    fulfillmentOptions: {
      'Science': {
        ...
        checker: includesWithSubRequirements(
          ...
          ['FDSC 4190'],
          ['FDSC 4230'],
          ['FDSC 4010', 'FDSC 4040', 'FDSC 4050', 'FDSC 4220', 'FDSC 4250',
            'FDSC 4400'],
          ['FDSC 4020', 'FDSC 4110', 'FDSC 4500', 'FDSC 4510', 'FDSC 4880',
            'FDSC 5970', 'FDSC 6950', 'FDSC 4010', 'FDSC 4040', 'FDSC 4050',
            'FDSC 4220', 'FDSC 4250', 'FDSC 4400']
        ),
        perSlotMinCount: [1, 1, 1, 1, 1, 1],
        slotNames: ['FDSC 3950', 'FDSC 4100', 'FDSC 4190', 'FDSC 4230', 'Group 1 >4000 electives', 'Group 2 >4000 electives'],
      },
      'Safety': {
        description:
        ...
        checker: includesWithSubRequirements(
          ...
          ['BIOMS 4040', 'BIOMS 4090', 'BIOMS 4150', 'BIOMS 4340', 'BIOMG 4390'], ['FDSC 4010', 'FDSC 4020', 'FDSC 4040', 'FDSC 4050', 'FDSC 4100', 'FDSC 4110', 'FDSC 4220', 'FDSC 4230', 'FDSC 4250', 'FDSC 4400', 'FDSC 4500', 'FDSC 4880', 'FDSC 5400']
        ),
        perSlotMinCount: [1, 1, 1, 1, 1, 1, 1],
        slotNames: ['FDSC 3950', 'FDSC 4230 or FDSC 4250', 'FDSC 5970', 'NS 3600 or PAM 3280 or ENTOM 4250 (in preferred order)', 'PAM 4240 or DSOC 4080 or ORIE 2380 (in preferred order)', 'BIOMS 4040 or BIOMS 4090 or BIOMS 4150 or BIOMS 4340 or BIOMG 4390 (in preferred order)', '2 credits of >4000 FDSC electives'],
      },
      'Business': {
        description:
        ...
        checker: includesWithSubRequirements(
          ...
          ['AEM 3340', 'AEM 3440', 'AEM 4485', 'AEM 3020', 'AEM 4420',
            'AEM 4450', 'AEM 3270', 'AEM 3230', 'AEM 2011', 'AEM 2220',
            'AEM 3249', 'AEM 2230', 'AEM 2015', 'AEM 3120', 'AEM 3249',
            'AEM 4190', 'NBA 5070', 'AEM 2480', 'HADM 3470']
        ),
        perSlotMinCount: [1, 1, 1, 1, 1, 1, 1, 1, 2],
        slotNames: ['FDSC 4230', 'FDSC 5970',
