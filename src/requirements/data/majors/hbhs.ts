...
const hbhsRequirements: readonly CollegeOrMajorRequirement[] = [
  {
    ...
    description: 'Students in the major must take CHEM 2070 - CHEM 2080 or CHEM 2150 with AP credit. ' +
      'Students, especially those on the pre-health track, are reccomended to take CHEM 2070 - CHEM 2080.',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
  ...
  {
    name: 'Introductory Biology Lab',
    description: 'BIOG 1500 or BIOSM 1500',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf', checker: includesWithSubRequirements(
      ['BIOG 1500', 'BIOSM 1500'],
    ),
    fulfilledBy: 'courses',
    perSlotMinCount: [1],
    slotNames: ['BIOG 1500 or BIOSM 1500'],
  },
  {
    name: 'Introductory Biology Lecture',
    description: 'Students must take 2 lectures coming from two of the three categories (Cell and Development, Comparative Physiology, and Ecology and Evolutionary).' +
    ...
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf', fulfilledBy: 'toggleable',
    fulfillmentOptions: {
      'Option 1': {
        description: 'Lectures in Cell and Development and Comparative Physiology or Ecology and Evolutionary',
        ...
        slotNames: [
          'BIOMG 1350',
          'BIOG 1440, BIOG 1445, BIOEE 1610, or BIOEE 1780',
        ],
      },
      'Option 2': {
        ...
        slotNames: [
          ...
          'BIOEE 1610 or BIOEE 1780',
        ],
      },
      'Option 3': {
        description: 'AP Credit and one lectrue in Cell and Development, Comparative Physiology, or Ecology and Evolutionary',
        checker: includesWithSubRequirements(
  ...
  {
    name: 'Physics',
    description: 'PHYS 1101 or PHYS 2207. Students interested in pre-health tracks should also take PHYS 1102 General Physics II OR PHYS 2208 Fundamentals of Physics',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
    checker: includesWithSubRequirements(
      ['PHYS 1101', 'PHYS 2207'],
    ),
  ...
  },
  {
    ...
    description: 'Students in the major must take one of the following sequences. Students interested in pre-health tracks should take a two-course sequence of organic chemistry lectures' +
  ...
  {
    name: 'Physiology',
    description: 'NS 3410 or BIOAP 3110. Pre-health students might also consider taking NS 3420 Human Anatomy and Physiology Lab (2 cr), which also counts toward advanced biology elective requirement',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
    checker: includesWithSubRequirements(
      ['NS 3410', 'BIOAP 3110'],
    ),
  ...
  },
  {
    ...
    description: '6 additional credits selected from didactic courses that relate to human biology. Any course that requires one year of introductory' +
    ...
    checker: [
      (course: Course): boolean =>
        !courseMatchesCodeOptions(course, ['BIOMG 3300']) && !courseMatchesCodeOptions(course, ['BIOMG 3310']) && !courseMatchesCodeOptions(course, ['BIOMG 3320']) && !courseMatchesCodeOptions(course, ['BIOMG 3350']) && !courseMatchesCodeOptions(course, ['NS 3200']),
  ...
  },
  {
    ...
    description: 'Courses should cover some aspect of health (including nutrition) from a social science perspective. More than half of the course content' +
  ...
  },
  {
    ...
    description: 'Courses should cover some aspect of health (including nutrition) from a life science perspective. More than half of the course content must' +
  ...
  },
  {
    ...
    description: 'Courses should cover some aspect of health (including nutrition) from a nutritional science perspective. More than half of the course' +
  ...
  },
  {
    ...
    description: 'Choose one course in any two of the following four areas: Anthropology, Economics, Psychology, and Sociology',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
    // Unsure how to check for this
    checker: [

    ],
    checkerWarning: 'We do not check that the courses are approved electives. We also do not check whether they come from two of the four areas.',
    fulfilledBy: 'credits',
    perSlotMinCount: [6],
  },
  {
  ...
  },
  {
    ...
    description: 'MATH 1105, MATH 1106, MATH 1110, or MATH 1120. A score of 4 or 5 on AB or BC Calculus AP Exam can be used as credit for this requirement. DNS students must take either Calculus/Advanced Math' +
    ...
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
    checker: includesWithSubRequirements(
      ['MATH 1105', 'MATH 1106', 'MATH 1110', 'MATH 1120'],
    ),
    fulfilledBy: 'courses',
    perSlotMinCount: [1],
  ...
  {
    name: 'Statistics',
    description: 'STSCI 2150, PAM 2100, AEM 2100, BTRY 3010, ILRST 2100, STSCI 2100, MATH 1710, PSYCH 2500, or SOC 3010. A score of 4 or 5 on the Statisitcs AP Exam can be used as credit for this requirement. DNS students must take either Calculus/Advanced Math' +
      'or Statistics at Cornell unless they have earned a score of 4 or 5 on the BC' +
      'Calculus AP Exam. Students in this case may use AP credit for both Calculus/Advanced Math and Statistics.',
    source: 'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
    checker: includesWithSubRequirements(
      ['STSCI 2150', 'PAM 2100', 'AEM 2100', 'BTRY 3010', 'ILRST 2100', 'STSCI 2100', 'MATH 1710', 'PSYCH 2500', 'SOC 3010'],
    ),
    fulfilledBy: 'courses',
    perSlotMinCount: [1],
    slotNames: ['STSCI 2150, PAM 2100, AEM 2100, BTRY 3010, ILRST 2100, STSCI 2100, MATH 1710, PSYCH 2500, or SOC 3010'],
  },
  {
    name: 'Electives',
