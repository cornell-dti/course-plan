...
const hbhsRequirements: readonly CollegeOrMajorRequirement[] = [
  {
    ...
    description:
      'Students in the major must take CHEM 2070 - CHEM 2080 or CHEM 2150 with AP credit. ' +
  ...
  },
  {
    ...
    fulfillmentOptions: {
      ...
      'Option 3': {
        description:
          'AP Credit and one lectrue in Cell and Development, Comparative Physiology, or Ecology and Evolutionary',
        checker: includesWithSubRequirements([
  ...
  },
  {
    name: 'Physics',
    description:
      'PHYS 1101 or PHYS 2207. Students interested in pre-health tracks should also take PHYS 1102 General Physics II OR PHYS 2208 Fundamentals of Physics',
    source:
      'https://www.human.cornell.edu/sites/default/files/Academics/Registrar/Curriculum%20sheets/2021-2022/HBHS%20Curriculum%20Sheet%202021-2022.pdf',
