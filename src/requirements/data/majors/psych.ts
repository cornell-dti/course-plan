...
const psychRequirements: readonly CollegeOrMajorRequirement[] = [
{
    ...
    source:
        'https://psychology.cornell.edu/major',
    ...
    },
  {
    ...
    description:
      'Students are required to demonstrate their proficiency in statistics',
    source:
      'https://psychology.cornell.edu/major',
  ...
  },
  {
    ...
    slotNames: ['Perception, cognition and development (PCD)', 'Behavioral and evolutionary neuroscience (BEN)', 'Social and personality psychology (S&P)','Other courses'],
    },
    {
