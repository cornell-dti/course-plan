    ...
    fulfillmentOptions: {
      ...
      'Applied Mathematics': {
        ...
        checker: includesWithSubRequirements(
          ['MATH 3***', 'MATH 4***', 'MATH 5***', 'MATH 6***', 'MATH 7***'],
          ['MATH 3610', 'CS 2110', 'PHYS 1116', 'PHYS 2208', 'PHYS 2213', 'PHYS 2217']
          // TODO - these bottom 4 need to be their own subrequirement + double countable to the above requirement^
          // ['MATH 3230', 'MATH 4200', 'MATH 4210', 'MATH 4280'],
          // [
          //   'MATH 3360',
          //   'MATH 4370',
          //   'MATH 4410',
          ...
          //   'ORIE 4350',
          // ],
          // ['MATH 4250', 'MATH 4260', 'CS 4620', 'CS 4670', 'MAE 4700'],
          // [
          //   'MATH 4710',
          //   'MATH 4720',
          //   'MATH 4740',
      ...
      'Computer Science': {
        ...
        perSlotMinCount: [1, 3],
        minNumberOfSlots: 5,
        slotNames: ['3000+ Math Course', 'Mathematical CS Courses'],
      },
      Economics: {
        description:
        ...
        // Fifth class can be in any of the 3 sub-requirements
        perSlotMinCount: [1, 3, 1],
        minNumberOfSlots: 5,
        slotNames: ['3000+ MATH Course', 'Mathematical ECON Courses', 'Mathematical ORIE Course'],
      },
      Biology: {
        description:
      ...
      Physics: {
        ...
        perSlotMinCount: [1, 3],
        minNumberOfSlots: 5,
        slotNames: ['3000+ MATH Course', 'Physics Courses'],
      },
      'Operations Research': {
        description:
          '5 courses from (i) and (ii): ' +
        ...
        perSlotMinCount: [1, 3],
        minNumberOfSlots: 5,
        slotNames: ['3000+ MATH Course', 'ORIE Courses'],
      },
      Statistics: {
        description:
          'MATH 4710, MATH 4720, ' +
