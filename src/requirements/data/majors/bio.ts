...
const bioRequirements: readonly CollegeOrMajorRequirement[] = [
  {
    ...
    description: 'Take 2 of the following 3: BIOMG 1350, BIOG 1440 OR BIOG 1445, BIOEE 1610 OR BIOSM 1610',
  ...
  {
    name: 'General Chemistry Option 1',
  ...
  },
  {
    ...
    description: 'Two courses. One semester of calculus (MATH 1106 OR MATH 1110) '
