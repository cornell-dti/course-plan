...
export const DEFAULT_COLLEGES = 'DEFAULT';
    ...
    Chemistry: [
      {
        courseId: 102,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [351265], // CHEM 2070
          EN: [359187], // CHEM 2090
        },
        minimumScore: 5,
        credits: 4,
    ...
    'Computer Science A': [
      {
        courseId: 103,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [358526], // CS 1110
        },
        minimumScore: 5,
        credits: 4,
      },
    ...
    Microeconomics: [
      {
        courseId: 104,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [350025], // ECON 1110
        },
        minimumScore: 4,
        credits: 3,
      },
    ...
    Macroeconomics: [
      {
        courseId: 106,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [350038], // ECON 1120
        },
        minimumScore: 4,
        credits: 3,
      },
    ...
    'English Literature and Composition': [
      {
        courseId: 107,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [FWS_COURSE_ID], // FWS
        },
        minimumScore: 4,
        credits: 3,
      },
    ...
    'French Language': [
      {
        courseId: 109,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [353172], // FREN 2090
        },
        minimumScore: 4,
        credits: 3,
      },
    ...
    'Mathematics BC (Non-Engineering)': [
      {
        courseId: 113,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [352116, 352120], // MATH 1110, MATH 1120
          EN: [],
        },
        minimumScore: 4,
        credits: 8,
    ...
    'Mathematics AB': [
      {
        courseId: 115,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [352116], // MATH 1110
        },
        minimumScore: 4,
        credits: 4,
      },
    ...
    'Physics I': [
      {
        courseId: 116,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355142], // PHYS 1101
        },
        minimumScore: 5,
        credits: 4,
      },
    ...
    'Physics II': [
      {
        courseId: 117,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355143], // PHYS 1102
        },
        minimumScore: 5,
        credits: 4,
      },
    ...
    'Physics C-Mechanics': [
      {
        courseId: 118,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355197], // PHYS 2207
          EN: [355146], // PHYS 1112
        },
        minimumScore: 5,
        credits: 4,
    ...
    'Physics C-Electricity & Magnetism': [
      {
        courseId: 119,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355207], // PHYS 2213
        },
        minimumScore: 5,
        credits: 4,
      },
    ...
    Psychology: [
      {
        courseId: 120,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [351438], // PSYCH 1101
        },
        minimumScore: 4,
        credits: 3,
      },
    ...
    'Chemical and Physical Systems': [
      {
        courseId: 200,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355142, 355143], // PHYS 1101, PHYS 1102
        },
        minimumScore: 6,
        credits: 8,
      },
    ...
    Economics: [
      {
        courseId: 204,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [350025, 350038], // ECON 1110, ECON 1120
        },
        minimumScore: 6,
        credits: 6,
      },
    ...
    Mathematics: [
      {
        courseId: 207,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [352111, 352116], // MATH 1106, MATH 1110
        },
        minimumScore: 6,
        credits: 4,
      },
    ...
    'Physical Science': [
      {
        courseId: 208,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [351265, 355142], // CHEM 2070, PHYS 1101
        },
        minimumScore: 6,
        credits: 8,
      },
    ...
    Physics: [
      {
        courseId: 209,
        courseEquivalents: {
          [DEFAULT_COLLEGES]: [355142, 355197], // PHYS 1101, PHYS 2207
          EN: [355146], // PHYS 1112
        },
        minimumScore: 6,
        credits: 4,
