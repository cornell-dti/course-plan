...
export declare type CourseTaken = {
...
export declare type CollegeRequirements<R> = {
    readonly [collegeCode: string]: {
        readonly name: string;
        readonly requirements: readonly R[];
    };
};
export declare type MajorRequirements<R> = {
    readonly [collegeCode: string]: {
        readonly name: string;
...
declare type GenericRequirementsJson<R> = {
    readonly university: UniversityRequirements;
    readonly college: CollegeRequirements<R>;
    readonly major: MajorRequirements<R>;
};
export declare type RequirementsJson = GenericRequirementsJson<CollegeOrMajorRequirement>;
export declare type DecoratedRequirementsJson = {
    readonly university: UniversityRequirements;
...
export declare type RequirementFulfillment<M extends {}> = {
...
export declare type RequirementFulfillmentStatistics = {
    /**
...
export declare type GroupedRequirementFulfillmentReport = {
...
export declare type DisplayableRequirementFulfillment = RequirementFulfillment<RequirementFulfillmentStatistics & {
    displayDescription: boolean;
}>;
export declare type SingleMenuRequirement = {
