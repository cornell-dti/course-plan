...
const irlRequirements = [
    {
        ...
        checker: checkers_common_1.includesWithSubRequirements(['ILROB 1220'], ['ILRLR 1100'], ['ECON 1110'], ['ECON 1120'], ['ILRST 2100'], ['ILRLR 2010'], ['ILRHR 2600'], ['ILRLR 2050'], ['ILRLE 2400']),
        fulfilledBy: 'courses',
        minCount: 9
    },
    {
    ...
    },
    {
        ...
        checker: checkers_common_1.includesWithSingleRequirement('ILRHR 2360', 'ILRIC 2390', 'ILRLE 2400', 'ILRLR 2060', 'ILRLR 2070', 'ILROB 2230', 'ILROB 2290', 'ENGL 2880', 'ENGL 2890'),
        fulfilledBy: 'courses',
        minCount: 1
    },
    {
...
exports.default = irlRequirements;
