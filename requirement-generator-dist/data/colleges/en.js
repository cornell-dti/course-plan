...
const engineeringRequirements = [
    {
        ...
        checker: checkers_common_1.includesWithSubRequirements(['MATH 1910'], ['MATH 1920'], ['MATH 2930', 'MATH 2940']),
        fulfilledBy: 'credits',
        minCount: 14
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: checkers_common_1.includesWithSubRequirements(['PHYS 1112'], ['PHYS 2213']),
        fulfilledBy: 'credits',
        minCount: 8
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: checkers_common_1.includesWithSingleRequirement('CHEM 2090'),
        fulfilledBy: 'credits',
        minCount: 4
    },
    {
    ...
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: checkers_common_1.includesWithSingleRequirement('CS 1110', 'CS 1112', 'CS 1114', 'CS 1115'),
        fulfilledBy: 'credits',
        minCount: 4
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: (course) => course.subject === 'ENGRI',
        fulfilledBy: 'credits',
        minCount: 4
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: (course) => course.subject === 'ENGRD',
        fulfilledBy: 'credits',
        minCount: 6
    },
    {
        ...
        source: 'https://www.engineering.cornell.edu/students/undergraduate-students/curriculum/undergraduate-requirements',
        checker: (course) => (['CA', 'HA', 'LA/LAD', 'KCM', 'SBA', 'FL', 'CE'].some(distribution => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes(distribution), (_b !== null && _b !== void 0 ? _b : false); })),
        fulfilledBy: 'courses',
        minCount: 3,
        totalCount: 6
    },
...
exports.default = engineeringRequirements;
