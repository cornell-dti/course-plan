...
const calsCreditsRequirement = {
    ...
    checker: (course) => ['AG', 'BU'].includes(course.acadGroup),
    fulfilledBy: 'credits',
    minCount: 55,
    progressBar: true
};
const calsIntroductoryLifeSciencesOrBiologyRequirement = {
    ...
    checker: checkers_common_1.includesWithSingleRequirement('ANSC 1100', 'BIOAP 1100', 'BIOEE 1560', 'BIOEE 1610', 'BIOEE 1610', 'BIOEE 1610', 'BIOEE 1610', 'BIOEE 1780', 'BIOEE 1780', 'BIOEE 1780', 'BIOEE 2070', 'BIOEE 2526', 'BIOG 1106', 'BIOG 1140', 'BIOG 1140', 'BIOG 1191', 'BIOG 1440', 'BIOG 1440', 'BIOG 1440', 'BIOG 1445', 'BIOG 1445', 'BIOG 1500', 'BIOG 1500', 'BIOG 1500', 'BIOMG 1150', 'BIOMG 1290', 'BIOMG 1350', 'BIOMG 1350', 'BIOMG 1350', 'BIOMI 1100', 'BIOMI 1120', 'BIOPL 1120', 'BIOPL 1130', 'BIOPL 2400', 'BIOPL 2410', 'BIOPL 2490', 'BIOSM 1500', 'BIOSM 1551', 'BIOSM 1610', 'BIOSM 1650', 'BIOSM 1780', 'CSS 1120', 'EAS 1560', 'ENTOM 2011', 'ENTOM 2020', 'ENTOM 2030', 'FDSC 2204', 'HORT 1115', 'HORT 2204', 'PLBIO 2100', 'PLBIO 2400', 'PLBIO 2410', 'PLBIO 2450', 'PLBIO 2470', 'PLBIO 2490', 'PLBRG 2010', 'PLHRT 1115', 'PLHRT 2204', 'PLPA 2013', 'PLPA 2015', 'PLPA 2900', 'PLPPM 2013', 'PLPPM 2015', 'PLPPM 2900', 'PLSCI 1150', 'PLSCI 1300', 'PLSCI 1420', 'PLSCI 4190', 'PLSCS 1120', 'STS 2871', 'VIEN 2204'),
    fulfilledBy: 'credits',
    minCount: 6
};
const calsPhysicalAndLifeSciencesRequirement = {
...
const calsChemistryOrPhysicsRequiement = {
    ...
    source: 'https://cals.cornell.edu/undergraduate-students/student-services/degree-requirements/graduation-requirements/distribution-requirements',
    checker: (course) => ['CHEM', 'CHEME', 'PHYS'].includes(course.subject),
    fulfilledBy: 'credits',
    minCount: 3
};
const calsQuantitativeLiteracyRequirement = {
    ...
    source: 'https://cals.cornell.edu/undergraduate-students/student-services/degree-requirements/graduation-requirements/distribution-requirements',
    checker: (course) => ['MATH', 'STSCI'].includes(course.subject),
    fulfilledBy: 'courses',
    minCount: 1
};
const calsSocialSciencesAndHumanitiesRequiement = {
    ...
    source: 'https://cals.cornell.edu/undergraduate-students/student-services/degree-requirements/graduation-requirements/distribution-requirements',
    checker: [
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(CA-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(D-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(FL-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(HA-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(KCM-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(LA-'), (_b !== null && _b !== void 0 ? _b : false); },
        (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(SBA-'), (_b !== null && _b !== void 0 ? _b : false); }
    ],
    fulfilledBy: 'courses',
    minCount: 3,
    totalCount: 4
};
const calsHumanDiversityRequirement = {
    ...
    source: 'https://cals.cornell.edu/undergraduate-students/student-services/degree-requirements/graduation-requirements/distribution-requirements',
    checker: (course) => { var _a, _b; return _b = (_a = course.catalogDistr) === null || _a === void 0 ? void 0 : _a.includes('(D-'), (_b !== null && _b !== void 0 ? _b : false); },
    fulfilledBy: 'courses',
    minCount: 1
};
const calsWrittenAndOralExpressionRequirement = {
    ...
    ].some(keyword => { var _a, _b; return _b = (_a = course.catalogSatisfiesReq) === null || _a === void 0 ? void 0 : _a.includes(keyword), (_b !== null && _b !== void 0 ? _b : false); }),
    fulfilledBy: 'credits',
    minCount: 9
};
const calsWrittenExpressionRequirement = {
...
exports.default = calsRequirements;
