...
exports.includesWithSingleRequirement = (...includes) => (course) => (exports.courseMatchesCodeOptions(course, includes));
exports.includesWithSubRequirements = (...includes) => (includes.map(subRequirementInclude => (course) => exports.courseMatchesCodeOptions(course, subRequirementInclude)));
