...
const infoRequirements = [
    {
        ...
        checker: checkers_common_1.includesWithSubRequirements(['INFO 1200'], ['INFO 1300'], ['INFO 2040'], ['INFO 2450'], ['INFO 2950']),
        fulfilledBy: 'courses',
        minCount: 5
    },
    {
        ...
        checker: checkers_common_1.includesWithSubRequirements(['CS 1110'], ['MATH 1106', 'MATH 1110', 'MATH 1910'], [
            'AEM 2100',
            'BTRY 3010',
            'CEE 3040',
            'ECON 3110',
    ...
    },
    {
        ...
        checker: checkers_common_1.includesWithSubRequirements(['INFO 2300'], ['CS 2110'], ['CS 3110'], ['CS 3410'], ['INFO 3***', 'INFO 4***', 'INFO 5***', 'INFO 6***']),
        fulfilledBy: 'courses',
        minCount: 3
    }
];
exports.default = infoRequirements;
