...
const aemRequirements = [
    ...
    },
    {
        ...
        description: 'AEM 3200 and AEM 3230 are optional for the following three concentrations: '
            + 'applied economics; environmental, energy, and resource economics; and international trade and development.',
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSubRequirements(['AEM 2200'], ['AEM 2225'], ['AEM 2240'], ['AEM 2420'], ['AEM 2601'], ['AEM 3200'], ['AEM 3230']),
        fulfilledBy: 'courses',
        minCount: 7
    },
    {
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSubRequirements(['ECON 1110'], ['ECON 1120'], ['AEM 2600', 'ECON 3030']),
        fulfilledBy: 'courses',
        minCount: 3
    },
    {
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSubRequirements(['AEM 2100'], ['MATH 1110', 'MATH 1120'], ['AEM 2010']),
        fulfilledBy: 'courses',
        minCount: 3
    },
    {
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSingleRequirement('AEM 2770', 'AEM 2830', 'AEM 2840', 'AEM 3100', 'AEM 3390', 'AEM 4060', 'AEM 4110', 'AEM 4120', 'AEM 4190', 'BTRY 3080', 'ILRST 3080', 'STSCI 3080', 'ECON 3130', 'ECON 3140', 'ECON 4020', 'ILRST 2110', 'ILRST 3110'),
        fulfilledBy: 'credits',
        minCount: 3
    },
    {
        name: 'Applied Economics Requirements',
        description: 'At least 6 credits; must come from two of the four categories below. '
    ...
    },
    {
        ...
        description: 'Sophomore year: 3 credits. Focus: Critical thinking. '
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSingleRequirement('AEM 2000', 'AEM 2555', 'AEM 2800', 'AEM 2805', 'AEM 4940'),
        fulfilledBy: 'courses',
        minCount: 1
    },
    {
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSingleRequirement('AEM 3000'),
        fulfilledBy: 'courses',
        minCount: 1
    },
    {
        ...
        source: 'https://dyson.cornell.edu/programs/undergraduate/degree-requirements/core/',
        checker: checkers_common_1.includesWithSingleRequirement('AEM 4000'),
        fulfilledBy: 'courses',
        minCount: 1
    }
];
exports.default = aemRequirements;
