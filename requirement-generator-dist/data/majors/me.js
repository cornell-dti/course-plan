...
const mechnicalEngineeringRequirements = [
    {
        ...
        checker: checkers_common_1.includesWithSingleRequirement('ENGRD 2020'),
        fulfilledBy: 'courses',
        minCount: 1
    },
    {
        ...
        source: 'http://cornellengineeringhandbook.freeflowdp.com/cornellengineeringhandbook/5215877281438417/MobilePagedReplica.action?pm=2&folio=12#pg14',
        checker: checkers_common_1.includesWithSubRequirements(['MAE 2210'], ['MAE 2030'], ['MAE 2250'], ['MAE 3230'], ['MAE 3240'], ['MAE 3260'], ['MAE 3270'], ['MAE 3780', 'ENGRD 2100', 'PHYS 3360'], ['MAE 4272'], ['MAE 4300']),
        fulfilledBy: 'courses',
        minCount: 10
    },
    {
    ...
    },
    {
        ...
        source: 'http://cornellengineeringhandbook.freeflowdp.com/cornellengineeringhandbook/5215877281438417/MobilePagedReplica.action?pm=2&folio=12#pg14',
        checker: checkers_common_1.includesWithSingleRequirement('MAE 3100', 'ENGRD 2700', 'CEE 3040', 'ENGRD 3200', 'ENGRD 3100', 'BTRY 3010', 'CS 2800'),
        fulfilledBy: 'credits',
        minCount: 3
    },
    {
...
exports.default = mechnicalEngineeringRequirements;
